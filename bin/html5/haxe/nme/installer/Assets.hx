...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("images/game1/bullet.png", "images/game1/bullet.png");
			resourceTypes.set ("images/game1/bullet.png", "image");
			
			
			resourceNames.set ("images/game1/plane.png", "images/game1/plane.png");
			resourceTypes.set ("images/game1/plane.png", "image");
			
			
			resourceNames.set ("images/nav/bg.jpg", "images/nav/bg.jpg");
			resourceTypes.set ("images/nav/bg.jpg", "image");
			
			
			resourceNames.set ("xml/app.xml", "xml/app.xml");
			resourceTypes.set ("xml/app.xml", "text");
			
			resourceClasses.set ("fonts/nokiafc22.ttf", NME_fonts_nokiafc22_ttf);
			resourceNames.set ("fonts/nokiafc22.ttf", "fonts/nokiafc22.ttf");
			resourceTypes.set ("fonts/nokiafc22.ttf", "font");
			
			resourceClasses.set ("nokia", NME_assets_fonts_nokiafc22_ttf);
			resourceNames.set ("nokia", "assets/fonts/nokiafc22.ttf");
