...
{
HX_STACK_PUSH("QuartEaseIn::new","com/eclecticdesignstudio/motion/easing/Quart.hx",46);
{
}
;
	return null();
...
Float QuartEaseIn_obj::ease( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("QuartEaseIn::ease","com/eclecticdesignstudio/motion/easing/Quart.hx",60);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
...
Float QuartEaseIn_obj::calculate( Float k){
	HX_STACK_PUSH("QuartEaseIn::calculate","com/eclecticdesignstudio/motion/easing/Quart.hx",53);
	HX_STACK_THIS(this);
	HX_STACK_ARG(k,"k");
	HX_STACK_LINE(53)
	return (((k * k) * k) * k);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.QuartEaseIn"), hx::TCanCast< QuartEaseIn_obj> ,sStaticFields,sMemberFields,
