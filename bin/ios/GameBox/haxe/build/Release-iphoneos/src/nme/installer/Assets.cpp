...
bool useCache = __o_useCache.Default(true);
	HX_STACK_PUSH("Assets::getBitmapData","nme/installer/Assets.hx",60);
	HX_STACK_ARG(id,"id");
		...
		if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id)->__Field(HX_CSTRING("toLowerCase"),true)() == HX_CSTRING("image")))))){
			...
			if (((id.indexOf(HX_CSTRING(":"),null()) > (int)-1))){
				...
				if ((::nme::installer::Assets_obj::libraryTypes->exists(libraryName))){
					...
					HX_STACK_LINE(123)
					::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),125,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBitmapData")));
				}
			}
			else{
				HX_STACK_LINE(129)
				::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no BitmapData asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),131,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBitmapData")));
			}
		}
		HX_STACK_LINE(135)
		return null();
...
::native::utils::ByteArray Assets_obj::getBytes( ::String id){
	HX_STACK_PUSH("Assets::getBytes","nme/installer/Assets.hx",140);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(142)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(144)
	if ((::nme::installer::Assets_obj::resourceNames->exists(id))){
		...
		HX_STACK_LINE(150)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no String or ByteArray asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),150,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getBytes")));
		HX_STACK_LINE(152)
		return null();
	}
	HX_STACK_LINE(144)
...
::native::text::Font Assets_obj::getFont( ::String id){
	HX_STACK_PUSH("Assets::getFont","nme/installer/Assets.hx",159);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(161)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(163)
	if (((bool(::nme::installer::Assets_obj::resourceTypes->exists(id)) && bool((::nme::installer::Assets_obj::resourceTypes->get(id)->__Field(HX_CSTRING("toLowerCase"),true)() == HX_CSTRING("font")))))){
		...
		HX_STACK_LINE(169)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no Font asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),169,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getFont")));
		HX_STACK_LINE(171)
		return null();
	}
	HX_STACK_LINE(163)
...
::format::display::MovieClip Assets_obj::getMovieClip( ::String id){
	HX_STACK_PUSH("Assets::getMovieClip","nme/installer/Assets.hx",178);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(180)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(182)
	...
	if ((::nme::installer::Assets_obj::libraryTypes->exists(libraryName))){
		...
		HX_STACK_LINE(219)
		::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no asset library named \"") + libraryName) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),221,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getMovieClip")));
	}
	HX_STACK_LINE(225)
	return null();
}
...
::String Assets_obj::getResourceName( ::String id){
	HX_STACK_PUSH("Assets::getResourceName","nme/installer/Assets.hx",230);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(232)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(234)
...
::native::media::Sound Assets_obj::getSound( ::String id){
	HX_STACK_PUSH("Assets::getSound","nme/installer/Assets.hx",239);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(241)
	::nme::installer::Assets_obj::initialize();
	HX_STACK_LINE(243)
	...
	HX_STACK_LINE(257)
	::haxe::Log_obj::trace(((HX_CSTRING("[nme.Assets] There is no Sound asset with an ID of \"") + id) + HX_CSTRING("\"")),hx::SourceInfo(HX_CSTRING("Assets.hx"),257,HX_CSTRING("nme.installer.Assets"),HX_CSTRING("getSound")));
	HX_STACK_LINE(259)
	return null();
}
...
::String Assets_obj::getText( ::String id){
	HX_STACK_PUSH("Assets::getText","nme/installer/Assets.hx",264);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(266)
