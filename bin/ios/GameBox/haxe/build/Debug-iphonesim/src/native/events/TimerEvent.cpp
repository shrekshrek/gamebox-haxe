...
{
HX_STACK_PUSH("TimerEvent::new","native/events/TimerEvent.hx",11);
...
{
		HX_STACK_PUSH("TimerEvent::updateAfterEvent","native/events/TimerEvent.hx",32);
		HX_STACK_THIS(this);
	}
return null();
}
...
::String TimerEvent_obj::toString( ){
	HX_STACK_PUSH("TimerEvent::toString","native/events/TimerEvent.hx",25);
	HX_STACK_THIS(this);
	HX_STACK_LINE(25)
...
::native::events::Event TimerEvent_obj::clone( ){
	HX_STACK_PUSH("TimerEvent::clone","native/events/TimerEvent.hx",18);
	HX_STACK_THIS(this);
	HX_STACK_LINE(18)
