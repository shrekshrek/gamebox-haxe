...
{
HX_STACK_PUSH("Game2Page::new","com/shrek/gamebox/pages/Game2Page.hx",15);
{
	HX_STACK_LINE(15)
	super::__construct();
}
...
Void Game2Page_obj::onClickHandler( ::native::events::MouseEvent event){
{
		HX_STACK_PUSH("Game2Page::onClickHandler","com/shrek/gamebox/pages/Game2Page.hx",36);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC1(Game2Page_obj,onClickHandler,(void))

Void Game2Page_obj::transitionOut( ){
{
		HX_STACK_PUSH("Game2Page::transitionOut","com/shrek/gamebox/pages/Game2Page.hx",30);
		HX_STACK_THIS(this);
		HX_STACK_LINE(31)
...
{
		HX_STACK_PUSH("Game2Page::transitionIn","com/shrek/gamebox/pages/Game2Page.hx",20);
		HX_STACK_THIS(this);
		HX_STACK_LINE(21)
