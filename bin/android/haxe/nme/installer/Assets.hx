...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("images/game1/bullet.png", "images_game1_bullet_png");
			resourceTypes.set ("images/game1/bullet.png", "image");
			resourceNames.set ("images/game1/plane.png", "images_game1_plane_png");
			resourceTypes.set ("images/game1/plane.png", "image");
			resourceNames.set ("images/game2/iceman/iceman.png", "images_game2_iceman_iceman_png");
			resourceTypes.set ("images/game2/iceman/iceman.png", "image");
			resourceNames.set ("images/nav/bg.jpg", "images_nav_bg_jpg");
			resourceTypes.set ("images/nav/bg.jpg", "image");
			resourceNames.set ("xml/app.xml", "xml_app_xml");
			resourceTypes.set ("xml/app.xml", "text");
			resourceNames.set ("fonts/nokiafc22.ttf", "fonts_nokiafc22_ttf");
			resourceTypes.set ("fonts/nokiafc22.ttf", "font");
			resourceNames.set ("nokia", "assets_fonts_nokiafc22_ttf");
			resourceTypes.set ("nokia", "font");
