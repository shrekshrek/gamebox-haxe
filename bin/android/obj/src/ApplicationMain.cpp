...
Void ApplicationMain_obj::main( ){
{
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",40);
			{
				...
				if ((hasMain)){
					...
					HX_STACK_LINE(64)
					::com::shrek::gamebox::Main instance = ::Type_obj::createInstance(hx::ClassOf< ::com::shrek::gamebox::Main >(),Dynamic( Array_obj<Dynamic>::__new()));		HX_STACK_VAR(instance,"instance");
					HX_STACK_LINE(66)
		...
		HX_STACK_LINE(39)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)30,(int)0,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int(::nme::Lib_obj::VSYNC))) | int(::nme::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("GameBox"),null());
	}
return null();
}
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	...
	HX_STACK_LINE(107)
	if (((inName == HX_CSTRING("images/game1/bullet.png")))){
		HX_STACK_LINE(108)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("images/game1/bullet.png"),null());
	}
	HX_STACK_LINE(114)
	if (((inName == HX_CSTRING("images/game1/plane.png")))){
		HX_STACK_LINE(115)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("images/game1/plane.png"),null());
	}
	HX_STACK_LINE(121)
	if (((inName == HX_CSTRING("images/game2/iceman/iceman.png")))){
		HX_STACK_LINE(122)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("images/game2/iceman/iceman.png"),null());
	}
	HX_STACK_LINE(128)
