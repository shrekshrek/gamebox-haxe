...
Void Lib_obj::close( ){
{
		HX_STACK_PUSH("Lib::close","native/Lib.hx",51);
		HX_STACK_LINE(53)
	...
	HX_STACK_ARG(inIcon,"inIcon");
{
		...
		Void run(Dynamic inFrameHandle){
			HX_STACK_PUSH("*::_Function_1_1","native/Lib.hx",73);
			HX_STACK_ARG(inFrameHandle,"inFrameHandle");
			{
				...
				try{
				...
				catch(Dynamic __e){
					{
						Dynamic e = __e;{
							HX_STACK_LINE(88)
							::haxe::Log_obj::trace((HX_CSTRING("ERROR: ") + ::Std_obj::string(e)),hx::SourceInfo(HX_CSTRING("Lib.hx"),88,HX_CSTRING("native.Lib"),HX_CSTRING("create")));
						}
					}
				}
			}
...
int inFlags = __o_inFlags.Default(0);
	HX_STACK_PUSH("Lib::createManagedStage","native/Lib.hx",96);
	HX_STACK_ARG(inWidth,"inWidth");
	HX_STACK_ARG(inHeight,"inHeight");
	HX_STACK_ARG(inFlags,"inFlags");
{
...
Void Lib_obj::exit( ){
{
		HX_STACK_PUSH("Lib::exit","native/Lib.hx",109);
		HX_STACK_LINE(111)
		Dynamic quit = ::native::Lib_obj::get_stage()->onQuit_dyn();		HX_STACK_VAR(quit,"quit");
		HX_STACK_LINE(113)
		if (((quit != null()))){
			HX_STACK_LINE(116)
			if (((quit == ::native::Lib_obj::close_dyn()))){
				HX_STACK_LINE(116)
				::Sys_obj::exit((int)0);
			}
			HX_STACK_LINE(123)
...
{
		HX_STACK_PUSH("Lib::forceClose","native/Lib.hx",130);
		HX_STACK_LINE(133)
...
int Lib_obj::getTimer( ){
	HX_STACK_PUSH("Lib::getTimer","native/Lib.hx",139);
	HX_STACK_LINE(139)
...
{
		HX_STACK_PUSH("Lib::getURL","native/Lib.hx",147);
...
{
		HX_STACK_PUSH("Lib::nmeSetCurrentStage","native/Lib.hx",154);
...
Void Lib_obj::pause( ){
{
		HX_STACK_PUSH("Lib::pause","native/Lib.hx",161);
		HX_STACK_LINE(161)
...
{
		HX_STACK_PUSH("Lib::postUICallback","native/Lib.hx",168);
		HX_STACK_ARG(inCallback,"inCallback");
		HX_STACK_LINE(168)
		::native::Lib_obj::nme_post_ui_callback(inCallback);
	}
return null();
}
...
Void Lib_obj::resume( ){
{
		HX_STACK_PUSH("Lib::resume","native/Lib.hx",181);
		HX_STACK_LINE(181)
...
{
		HX_STACK_PUSH("Lib::setIcon","native/Lib.hx",196);
...
{
		HX_STACK_PUSH("Lib::setPackage","native/Lib.hx",205);
...
::native::display::MovieClip Lib_obj::get_current( ){
	HX_STACK_PUSH("Lib::get_current","native/Lib.hx",224);
	HX_STACK_LINE(226)
	if (((::native::Lib_obj::nmeCurrent == null()))){
		HX_STACK_LINE(228)
...
::native::display::Stage Lib_obj::get_stage( ){
	HX_STACK_PUSH("Lib::get_stage","native/Lib.hx",240);
	HX_STACK_LINE(242)
	if (((::native::Lib_obj::nmeStage == null()))){
		HX_STACK_LINE(243)
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Lib_obj::nme_post_ui_callback,"nme_post_ui_callback");
...
void Lib_obj::__boot()
{
	...
	nmeStage= null();
	sIsInit= false;
	nme_post_ui_callback= ::native::Loader_obj::load(HX_CSTRING("nme_post_ui_callback"),(int)1);
