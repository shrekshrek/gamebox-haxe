...
{
HX_STACK_PUSH("Timer::new","native/utils/Timer.hx",21);
...
{
		HX_STACK_PUSH("Timer::timer_onTimer","native/utils/Timer.hx",115);
		HX_STACK_THIS(this);
		HX_STACK_LINE(117)
		(this->currentCount)++;
		HX_STACK_LINE(119)
...
Float Timer_obj::set_delay( Float value){
	HX_STACK_PUSH("Timer::set_delay","native/utils/Timer.hx",92);
	HX_STACK_THIS(this);
...
Float Timer_obj::get_delay( ){
	HX_STACK_PUSH("Timer::get_delay","native/utils/Timer.hx",85);
	HX_STACK_THIS(this);
	HX_STACK_LINE(85)
	return this->_delay;
}
...
Void Timer_obj::stop( ){
{
		HX_STACK_PUSH("Timer::stop","native/utils/Timer.hx",64);
		HX_STACK_THIS(this);
		HX_STACK_LINE(66)
		this->running = false;
		HX_STACK_LINE(68)
...
{
		HX_STACK_PUSH("Timer::start","native/utils/Timer.hx",51);
		HX_STACK_THIS(this);
		HX_STACK_LINE(51)
		if ((!(this->running))){
			HX_STACK_LINE(55)
...
{
		HX_STACK_PUSH("Timer::reset","native/utils/Timer.hx",38);
		HX_STACK_THIS(this);
		HX_STACK_LINE(40)
		if ((this->running)){
			HX_STACK_LINE(40)
