...
{
HX_STACK_PUSH("AccelerometerEvent::new","native/events/AccelerometerEvent.hx",18);
...
::String AccelerometerEvent_obj::toString( ){
	HX_STACK_PUSH("AccelerometerEvent::toString","native/events/AccelerometerEvent.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_LINE(37)
...
::native::events::Event AccelerometerEvent_obj::clone( ){
	HX_STACK_PUSH("AccelerometerEvent::clone","native/events/AccelerometerEvent.hx",30);
	HX_STACK_THIS(this);
	HX_STACK_LINE(30)
	return ::native::events::AccelerometerEvent_obj::__new(this->get_type(),this->get_bubbles(),this->get_cancelable(),this->timestamp,this->accelerationX,this->accelerationY,this->accelerationZ);
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.events.AccelerometerEvent"), hx::TCanCast< AccelerometerEvent_obj> ,sStaticFields,sMemberFields,
