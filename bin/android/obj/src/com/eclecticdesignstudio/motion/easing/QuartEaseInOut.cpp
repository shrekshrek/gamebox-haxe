...
{
HX_STACK_PUSH("QuartEaseInOut::new","com/eclecticdesignstudio/motion/easing/Quart.hx",73);
{
}
;
	return null();
...
Float QuartEaseInOut_obj::ease( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("QuartEaseInOut::ease","com/eclecticdesignstudio/motion/easing/Quart.hx",88);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
...
Float QuartEaseInOut_obj::calculate( Float k){
	HX_STACK_PUSH("QuartEaseInOut::calculate","com/eclecticdesignstudio/motion/easing/Quart.hx",80);
	HX_STACK_THIS(this);
	HX_STACK_ARG(k,"k");
	HX_STACK_LINE(82)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.QuartEaseInOut"), hx::TCanCast< QuartEaseInOut_obj> ,sStaticFields,sMemberFields,
