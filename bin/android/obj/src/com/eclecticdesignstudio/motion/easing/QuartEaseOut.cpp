...
{
HX_STACK_PUSH("QuartEaseOut::new","com/eclecticdesignstudio/motion/easing/Quart.hx",104);
{
}
;
	return null();
...
Float QuartEaseOut_obj::ease( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("QuartEaseOut::ease","com/eclecticdesignstudio/motion/easing/Quart.hx",118);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
...
Float QuartEaseOut_obj::calculate( Float k){
	HX_STACK_PUSH("QuartEaseOut::calculate","com/eclecticdesignstudio/motion/easing/Quart.hx",111);
	HX_STACK_THIS(this);
	HX_STACK_ARG(k,"k");
	HX_STACK_LINE(111)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.QuartEaseOut"), hx::TCanCast< QuartEaseOut_obj> ,sStaticFields,sMemberFields,
