...
{
HX_STACK_PUSH("ZNPNode_ZPP_Constraint::new","zpp_nape/util/Lists.hx",13780);
{
	HX_STACK_LINE(13814)
	this->elt = null();
	HX_STACK_LINE(13805)
...
::zpp_nape::constraint::ZPP_Constraint ZNPNode_ZPP_Constraint_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Constraint::elem","zpp_nape/util/Lists.hx",13818);
	HX_STACK_THIS(this);
	HX_STACK_LINE(13818)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Constraint::free","zpp_nape/util/Lists.hx",13811);
		HX_STACK_THIS(this);
		HX_STACK_LINE(13811)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Constraint::alloc","zpp_nape/util/Lists.hx",13808);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_Constraint"), hx::TCanCast< ZNPNode_ZPP_Constraint_obj> ,sStaticFields,sMemberFields,
