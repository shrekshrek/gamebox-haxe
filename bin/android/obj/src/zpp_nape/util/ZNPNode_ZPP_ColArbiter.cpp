...
{
HX_STACK_PUSH("ZNPNode_ZPP_ColArbiter::new","zpp_nape/util/Lists.hx",14805);
{
	HX_STACK_LINE(14839)
	this->elt = null();
	HX_STACK_LINE(14830)
...
::zpp_nape::dynamics::ZPP_ColArbiter ZNPNode_ZPP_ColArbiter_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_ColArbiter::elem","zpp_nape/util/Lists.hx",14843);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14843)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ColArbiter::free","zpp_nape/util/Lists.hx",14836);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14836)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ColArbiter::alloc","zpp_nape/util/Lists.hx",14833);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_ColArbiter"), hx::TCanCast< ZNPNode_ZPP_ColArbiter_obj> ,sStaticFields,sMemberFields,
