...
{
HX_STACK_PUSH("ZNPNode_ZPP_SimplifyP::new","zpp_nape/util/Lists.hx",14354);
{
	HX_STACK_LINE(14388)
	this->elt = null();
	HX_STACK_LINE(14379)
...
::zpp_nape::geom::ZPP_SimplifyP ZNPNode_ZPP_SimplifyP_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_SimplifyP::elem","zpp_nape/util/Lists.hx",14392);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14392)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_SimplifyP::free","zpp_nape/util/Lists.hx",14385);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14385)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_SimplifyP::alloc","zpp_nape/util/Lists.hx",14382);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_SimplifyP"), hx::TCanCast< ZNPNode_ZPP_SimplifyP_obj> ,sStaticFields,sMemberFields,
