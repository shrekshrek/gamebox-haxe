...
{
HX_STACK_PUSH("ZPP_RayResultList::new","zpp_nape/util/Lists.hx",15766);
{
	HX_STACK_LINE(15821)
...
{
		HX_STACK_PUSH("ZPP_RayResultList::invalidate","zpp_nape/util/Lists.hx",15813);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15814)
		this->_invalidated = true;
		HX_STACK_LINE(15815)
...
{
		HX_STACK_PUSH("ZPP_RayResultList::validate","zpp_nape/util/Lists.hx",15807);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15807)
...
{
		HX_STACK_PUSH("ZPP_RayResultList::modify_test","zpp_nape/util/Lists.hx",15802);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15802)
...
{
		HX_STACK_PUSH("ZPP_RayResultList::modified","zpp_nape/util/Lists.hx",15797);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15798)
...
{
		HX_STACK_PUSH("ZPP_RayResultList::valmod","zpp_nape/util/Lists.hx",15787);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15788)
		this->validate();
		HX_STACK_LINE(15789)
...
bool imm = __o_imm.Default(false);
	HX_STACK_PUSH("ZPP_RayResultList::get","zpp_nape/util/Lists.hx",15780);
