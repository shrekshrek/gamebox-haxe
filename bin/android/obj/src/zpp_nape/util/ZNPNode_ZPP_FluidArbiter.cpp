...
{
HX_STACK_PUSH("ZNPNode_ZPP_FluidArbiter::new","zpp_nape/util/Lists.hx",14641);
{
	HX_STACK_LINE(14675)
	this->elt = null();
	HX_STACK_LINE(14666)
...
::zpp_nape::dynamics::ZPP_FluidArbiter ZNPNode_ZPP_FluidArbiter_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_FluidArbiter::elem","zpp_nape/util/Lists.hx",14679);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14679)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_FluidArbiter::free","zpp_nape/util/Lists.hx",14672);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14672)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_FluidArbiter::alloc","zpp_nape/util/Lists.hx",14669);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_FluidArbiter"), hx::TCanCast< ZNPNode_ZPP_FluidArbiter_obj> ,sStaticFields,sMemberFields,
