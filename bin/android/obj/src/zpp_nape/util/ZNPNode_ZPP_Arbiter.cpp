...
{
HX_STACK_PUSH("ZNPNode_ZPP_Arbiter::new","zpp_nape/util/Lists.hx",13862);
{
	HX_STACK_LINE(13896)
	this->elt = null();
	HX_STACK_LINE(13887)
...
::zpp_nape::dynamics::ZPP_Arbiter ZNPNode_ZPP_Arbiter_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Arbiter::elem","zpp_nape/util/Lists.hx",13900);
	HX_STACK_THIS(this);
	HX_STACK_LINE(13900)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Arbiter::free","zpp_nape/util/Lists.hx",13893);
		HX_STACK_THIS(this);
		HX_STACK_LINE(13893)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Arbiter::alloc","zpp_nape/util/Lists.hx",13890);
		HX_STACK_THIS(this);
	}
return null();
}
