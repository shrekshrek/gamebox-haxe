...
{
HX_STACK_PUSH("ZNPNode_ZPP_Component::new","zpp_nape/util/Lists.hx",14559);
{
	HX_STACK_LINE(14593)
	this->elt = null();
	HX_STACK_LINE(14584)
...
::zpp_nape::space::ZPP_Component ZNPNode_ZPP_Component_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Component::elem","zpp_nape/util/Lists.hx",14597);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14597)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Component::free","zpp_nape/util/Lists.hx",14590);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14590)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Component::alloc","zpp_nape/util/Lists.hx",14587);
		HX_STACK_THIS(this);
	}
return null();
}
