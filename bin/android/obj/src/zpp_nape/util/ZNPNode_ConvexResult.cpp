...
{
HX_STACK_PUSH("ZNPNode_ConvexResult::new","zpp_nape/util/Lists.hx",14928);
{
	HX_STACK_LINE(14962)
	this->elt = null();
	HX_STACK_LINE(14953)
...
::nape::geom::ConvexResult ZNPNode_ConvexResult_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ConvexResult::elem","zpp_nape/util/Lists.hx",14966);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14966)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ConvexResult::free","zpp_nape/util/Lists.hx",14959);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14959)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ConvexResult::alloc","zpp_nape/util/Lists.hx",14956);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ConvexResult"), hx::TCanCast< ZNPNode_ConvexResult_obj> ,sStaticFields,sMemberFields,
