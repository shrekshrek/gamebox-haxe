...
{
HX_STACK_PUSH("ZPP_GeomPolyList::new","zpp_nape/util/Lists.hx",15704);
{
	HX_STACK_LINE(15759)
...
{
		HX_STACK_PUSH("ZPP_GeomPolyList::invalidate","zpp_nape/util/Lists.hx",15751);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15752)
		this->_invalidated = true;
		HX_STACK_LINE(15753)
...
{
		HX_STACK_PUSH("ZPP_GeomPolyList::validate","zpp_nape/util/Lists.hx",15745);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15745)
...
{
		HX_STACK_PUSH("ZPP_GeomPolyList::modify_test","zpp_nape/util/Lists.hx",15740);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15740)
...
{
		HX_STACK_PUSH("ZPP_GeomPolyList::modified","zpp_nape/util/Lists.hx",15735);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15736)
...
{
		HX_STACK_PUSH("ZPP_GeomPolyList::valmod","zpp_nape/util/Lists.hx",15725);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15726)
		this->validate();
		HX_STACK_LINE(15727)
...
bool imm = __o_imm.Default(false);
	HX_STACK_PUSH("ZPP_GeomPolyList::get","zpp_nape/util/Lists.hx",15718);
