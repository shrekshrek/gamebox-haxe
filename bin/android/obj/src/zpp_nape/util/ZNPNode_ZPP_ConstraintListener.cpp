...
{
HX_STACK_PUSH("ZNPNode_ZPP_ConstraintListener::new","zpp_nape/util/Lists.hx",14067);
{
	HX_STACK_LINE(14101)
	this->elt = null();
	HX_STACK_LINE(14092)
...
::zpp_nape::callbacks::ZPP_ConstraintListener ZNPNode_ZPP_ConstraintListener_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_ConstraintListener::elem","zpp_nape/util/Lists.hx",14105);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14105)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ConstraintListener::free","zpp_nape/util/Lists.hx",14098);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14098)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ConstraintListener::alloc","zpp_nape/util/Lists.hx",14095);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_ConstraintListener"), hx::TCanCast< ZNPNode_ZPP_ConstraintListener_obj> ,sStaticFields,sMemberFields,
