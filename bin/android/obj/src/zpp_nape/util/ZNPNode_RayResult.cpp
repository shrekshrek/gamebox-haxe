...
{
HX_STACK_PUSH("ZNPNode_RayResult::new","zpp_nape/util/Lists.hx",15010);
{
	HX_STACK_LINE(15044)
	this->elt = null();
	HX_STACK_LINE(15035)
...
::nape::geom::RayResult ZNPNode_RayResult_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_RayResult::elem","zpp_nape/util/Lists.hx",15048);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15048)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_RayResult::free","zpp_nape/util/Lists.hx",15041);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15041)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_RayResult::alloc","zpp_nape/util/Lists.hx",15038);
		HX_STACK_THIS(this);
	}
return null();
}
