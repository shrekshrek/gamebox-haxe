...
{
HX_STACK_PUSH("ZNPNode_ZPP_Interactor::new","zpp_nape/util/Lists.hx",13944);
{
	HX_STACK_LINE(13978)
	this->elt = null();
	HX_STACK_LINE(13969)
...
::zpp_nape::phys::ZPP_Interactor ZNPNode_ZPP_Interactor_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Interactor::elem","zpp_nape/util/Lists.hx",13982);
	HX_STACK_THIS(this);
	HX_STACK_LINE(13982)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Interactor::free","zpp_nape/util/Lists.hx",13975);
		HX_STACK_THIS(this);
		HX_STACK_LINE(13975)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Interactor::alloc","zpp_nape/util/Lists.hx",13972);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_Interactor"), hx::TCanCast< ZNPNode_ZPP_Interactor_obj> ,sStaticFields,sMemberFields,
