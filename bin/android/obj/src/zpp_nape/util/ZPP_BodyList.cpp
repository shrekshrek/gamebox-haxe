...
{
HX_STACK_PUSH("ZPP_BodyList::new","zpp_nape/util/Lists.hx",15332);
{
	HX_STACK_LINE(15387)
...
{
		HX_STACK_PUSH("ZPP_BodyList::invalidate","zpp_nape/util/Lists.hx",15379);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15380)
		this->_invalidated = true;
		HX_STACK_LINE(15381)
...
{
		HX_STACK_PUSH("ZPP_BodyList::validate","zpp_nape/util/Lists.hx",15373);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15373)
...
{
		HX_STACK_PUSH("ZPP_BodyList::modify_test","zpp_nape/util/Lists.hx",15368);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15368)
...
{
		HX_STACK_PUSH("ZPP_BodyList::modified","zpp_nape/util/Lists.hx",15363);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15364)
...
{
		HX_STACK_PUSH("ZPP_BodyList::valmod","zpp_nape/util/Lists.hx",15353);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15354)
		this->validate();
		HX_STACK_LINE(15355)
...
bool imm = __o_imm.Default(false);
	HX_STACK_PUSH("ZPP_BodyList::get","zpp_nape/util/Lists.hx",15346);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZPP_BodyList"), hx::TCanCast< ZPP_BodyList_obj> ,sStaticFields,sMemberFields,
