...
{
HX_STACK_PUSH("ZNPNode_ZPP_AABBPair::new","zpp_nape/util/Lists.hx",14477);
{
	HX_STACK_LINE(14511)
	this->elt = null();
	HX_STACK_LINE(14502)
...
::zpp_nape::space::ZPP_AABBPair ZNPNode_ZPP_AABBPair_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_AABBPair::elem","zpp_nape/util/Lists.hx",14515);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14515)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_AABBPair::free","zpp_nape/util/Lists.hx",14508);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14508)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_AABBPair::alloc","zpp_nape/util/Lists.hx",14505);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_AABBPair"), hx::TCanCast< ZNPNode_ZPP_AABBPair_obj> ,sStaticFields,sMemberFields,
