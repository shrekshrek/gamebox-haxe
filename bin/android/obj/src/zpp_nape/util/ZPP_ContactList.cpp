...
{
HX_STACK_PUSH("ZPP_ContactList::new","zpp_nape/util/Lists.hx",16138);
{
	HX_STACK_LINE(16193)
...
{
		HX_STACK_PUSH("ZPP_ContactList::invalidate","zpp_nape/util/Lists.hx",16185);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16186)
		this->_invalidated = true;
		HX_STACK_LINE(16187)
...
{
		HX_STACK_PUSH("ZPP_ContactList::validate","zpp_nape/util/Lists.hx",16179);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16179)
...
{
		HX_STACK_PUSH("ZPP_ContactList::modify_test","zpp_nape/util/Lists.hx",16174);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16174)
...
{
		HX_STACK_PUSH("ZPP_ContactList::modified","zpp_nape/util/Lists.hx",16169);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16170)
...
{
		HX_STACK_PUSH("ZPP_ContactList::valmod","zpp_nape/util/Lists.hx",16159);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16160)
		this->validate();
		HX_STACK_LINE(16161)
...
bool imm = __o_imm.Default(false);
	HX_STACK_PUSH("ZPP_ContactList::get","zpp_nape/util/Lists.hx",16152);
