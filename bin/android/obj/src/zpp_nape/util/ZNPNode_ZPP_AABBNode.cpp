...
{
HX_STACK_PUSH("ZNPNode_ZPP_AABBNode::new","zpp_nape/util/Lists.hx",14764);
{
	HX_STACK_LINE(14798)
	this->elt = null();
	HX_STACK_LINE(14789)
...
::zpp_nape::space::ZPP_AABBNode ZNPNode_ZPP_AABBNode_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_AABBNode::elem","zpp_nape/util/Lists.hx",14802);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14802)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_AABBNode::free","zpp_nape/util/Lists.hx",14795);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14795)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_AABBNode::alloc","zpp_nape/util/Lists.hx",14792);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_AABBNode"), hx::TCanCast< ZNPNode_ZPP_AABBNode_obj> ,sStaticFields,sMemberFields,
