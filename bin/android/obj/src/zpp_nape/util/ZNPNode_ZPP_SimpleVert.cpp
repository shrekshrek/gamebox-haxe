...
{
HX_STACK_PUSH("ZNPNode_ZPP_SimpleVert::new","zpp_nape/util/Lists.hx",14395);
{
	HX_STACK_LINE(14429)
	this->elt = null();
	HX_STACK_LINE(14420)
...
{  hx::ObjectPtr< ZNPNode_ZPP_SimpleVert_obj > result = new ZNPNode_ZPP_SimpleVert_obj();
	result->__construct();
	return result;}
...
::zpp_nape::geom::ZPP_SimpleVert ZNPNode_ZPP_SimpleVert_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_SimpleVert::elem","zpp_nape/util/Lists.hx",14433);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14433)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_SimpleVert::free","zpp_nape/util/Lists.hx",14426);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14426)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_SimpleVert::alloc","zpp_nape/util/Lists.hx",14423);
		HX_STACK_THIS(this);
	}
return null();
}
...
Dynamic ZNPNode_ZPP_SimpleVert_obj::__Field(const ::String &inName,bool inCallProp)
{
...
Dynamic ZNPNode_ZPP_SimpleVert_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 3:
	...
	case 4:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"zpp_pool") ) { zpp_pool=inValue.Cast< ::zpp_nape::util::ZNPNode_ZPP_SimpleVert >(); return inValue; }
	}
...
Class ZNPNode_ZPP_SimpleVert_obj::__mClass;

void ZNPNode_ZPP_SimpleVert_obj::__register()
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_SimpleVert"), hx::TCanCast< ZNPNode_ZPP_SimpleVert_obj> ,sStaticFields,sMemberFields,
