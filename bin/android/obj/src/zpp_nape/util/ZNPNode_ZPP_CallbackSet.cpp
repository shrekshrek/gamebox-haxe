...
{
HX_STACK_PUSH("ZNPNode_ZPP_CallbackSet::new","zpp_nape/util/Lists.hx",13657);
{
	HX_STACK_LINE(13691)
	this->elt = null();
	HX_STACK_LINE(13682)
...
::zpp_nape::space::ZPP_CallbackSet ZNPNode_ZPP_CallbackSet_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_CallbackSet::elem","zpp_nape/util/Lists.hx",13695);
	HX_STACK_THIS(this);
	HX_STACK_LINE(13695)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_CallbackSet::free","zpp_nape/util/Lists.hx",13688);
		HX_STACK_THIS(this);
		HX_STACK_LINE(13688)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_CallbackSet::alloc","zpp_nape/util/Lists.hx",13685);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_CallbackSet"), hx::TCanCast< ZNPNode_ZPP_CallbackSet_obj> ,sStaticFields,sMemberFields,
