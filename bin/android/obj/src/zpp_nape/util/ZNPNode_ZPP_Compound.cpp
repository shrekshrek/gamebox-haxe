...
{
HX_STACK_PUSH("ZNPNode_ZPP_Compound::new","zpp_nape/util/Lists.hx",13821);
{
	HX_STACK_LINE(13855)
	this->elt = null();
	HX_STACK_LINE(13846)
...
::zpp_nape::phys::ZPP_Compound ZNPNode_ZPP_Compound_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Compound::elem","zpp_nape/util/Lists.hx",13859);
	HX_STACK_THIS(this);
	HX_STACK_LINE(13859)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Compound::free","zpp_nape/util/Lists.hx",13852);
		HX_STACK_THIS(this);
		HX_STACK_LINE(13852)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Compound::alloc","zpp_nape/util/Lists.hx",13849);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_Compound"), hx::TCanCast< ZNPNode_ZPP_Compound_obj> ,sStaticFields,sMemberFields,
