...
{
HX_STACK_PUSH("ZNPNode_ZPP_GeomVert::new","zpp_nape/util/Lists.hx",14313);
{
	HX_STACK_LINE(14347)
	this->elt = null();
	HX_STACK_LINE(14338)
...
::zpp_nape::geom::ZPP_GeomVert ZNPNode_ZPP_GeomVert_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_GeomVert::elem","zpp_nape/util/Lists.hx",14351);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14351)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_GeomVert::free","zpp_nape/util/Lists.hx",14344);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14344)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_GeomVert::alloc","zpp_nape/util/Lists.hx",14341);
		HX_STACK_THIS(this);
	}
return null();
}
