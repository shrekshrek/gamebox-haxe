...
{
HX_STACK_PUSH("ZNPNode_ZPP_GeomPoly::new","zpp_nape/util/Lists.hx",14969);
{
	HX_STACK_LINE(15003)
	this->elt = null();
	HX_STACK_LINE(14994)
...
::zpp_nape::geom::ZPP_GeomPoly ZNPNode_ZPP_GeomPoly_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_GeomPoly::elem","zpp_nape/util/Lists.hx",15007);
	HX_STACK_THIS(this);
	HX_STACK_LINE(15007)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_GeomPoly::free","zpp_nape/util/Lists.hx",15000);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15000)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_GeomPoly::alloc","zpp_nape/util/Lists.hx",14997);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_GeomPoly"), hx::TCanCast< ZNPNode_ZPP_GeomPoly_obj> ,sStaticFields,sMemberFields,
