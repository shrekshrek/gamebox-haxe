...
{
HX_STACK_PUSH("ZNPNode_ZPP_InteractionListener::new","zpp_nape/util/Lists.hx",13985);
{
	HX_STACK_LINE(14019)
	this->elt = null();
	HX_STACK_LINE(14010)
...
::zpp_nape::callbacks::ZPP_InteractionListener ZNPNode_ZPP_InteractionListener_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_InteractionListener::elem","zpp_nape/util/Lists.hx",14023);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14023)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_InteractionListener::free","zpp_nape/util/Lists.hx",14016);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14016)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_InteractionListener::alloc","zpp_nape/util/Lists.hx",14013);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_InteractionListener"), hx::TCanCast< ZNPNode_ZPP_InteractionListener_obj> ,sStaticFields,sMemberFields,
