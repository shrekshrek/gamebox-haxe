...
{
HX_STACK_PUSH("ZPP_InteractorList::new","zpp_nape/util/Lists.hx",15394);
{
	HX_STACK_LINE(15449)
...
{
		HX_STACK_PUSH("ZPP_InteractorList::invalidate","zpp_nape/util/Lists.hx",15441);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15442)
		this->_invalidated = true;
		HX_STACK_LINE(15443)
...
{
		HX_STACK_PUSH("ZPP_InteractorList::validate","zpp_nape/util/Lists.hx",15435);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15435)
...
{
		HX_STACK_PUSH("ZPP_InteractorList::modify_test","zpp_nape/util/Lists.hx",15430);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15430)
...
{
		HX_STACK_PUSH("ZPP_InteractorList::modified","zpp_nape/util/Lists.hx",15425);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15426)
...
{
		HX_STACK_PUSH("ZPP_InteractorList::valmod","zpp_nape/util/Lists.hx",15415);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15416)
		this->validate();
		HX_STACK_LINE(15417)
...
bool imm = __o_imm.Default(false);
	HX_STACK_PUSH("ZPP_InteractorList::get","zpp_nape/util/Lists.hx",15408);
