...
{
HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::new","zpp_nape/util/Lists.hx",14846);
{
	HX_STACK_LINE(14880)
	this->elt = null();
	HX_STACK_LINE(14871)
...
::zpp_nape::geom::ZPP_ToiEvent ZNPNode_ZPP_ToiEvent_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::elem","zpp_nape/util/Lists.hx",14884);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14884)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::free","zpp_nape/util/Lists.hx",14877);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14877)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_ToiEvent::alloc","zpp_nape/util/Lists.hx",14874);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_ToiEvent"), hx::TCanCast< ZNPNode_ZPP_ToiEvent_obj> ,sStaticFields,sMemberFields,
