...
{
HX_STACK_PUSH("ZPP_ListenerList::new","zpp_nape/util/Lists.hx",15518);
{
	HX_STACK_LINE(15573)
...
{
		HX_STACK_PUSH("ZPP_ListenerList::invalidate","zpp_nape/util/Lists.hx",15565);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15566)
		this->_invalidated = true;
		HX_STACK_LINE(15567)
...
{
		HX_STACK_PUSH("ZPP_ListenerList::validate","zpp_nape/util/Lists.hx",15559);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15559)
...
{
		HX_STACK_PUSH("ZPP_ListenerList::modify_test","zpp_nape/util/Lists.hx",15554);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15554)
...
{
		HX_STACK_PUSH("ZPP_ListenerList::modified","zpp_nape/util/Lists.hx",15549);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15550)
...
{
		HX_STACK_PUSH("ZPP_ListenerList::valmod","zpp_nape/util/Lists.hx",15539);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15540)
		this->validate();
		HX_STACK_LINE(15541)
...
bool imm = __o_imm.Default(false);
	HX_STACK_PUSH("ZPP_ListenerList::get","zpp_nape/util/Lists.hx",15532);
