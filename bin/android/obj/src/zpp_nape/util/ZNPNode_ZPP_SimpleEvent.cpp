...
{
HX_STACK_PUSH("ZNPNode_ZPP_SimpleEvent::new","zpp_nape/util/Lists.hx",14436);
{
	HX_STACK_LINE(14470)
	this->elt = null();
	HX_STACK_LINE(14461)
...
::zpp_nape::geom::ZPP_SimpleEvent ZNPNode_ZPP_SimpleEvent_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_SimpleEvent::elem","zpp_nape/util/Lists.hx",14474);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14474)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_SimpleEvent::free","zpp_nape/util/Lists.hx",14467);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14467)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_SimpleEvent::alloc","zpp_nape/util/Lists.hx",14464);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_SimpleEvent"), hx::TCanCast< ZNPNode_ZPP_SimpleEvent_obj> ,sStaticFields,sMemberFields,
