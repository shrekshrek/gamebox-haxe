...
{
HX_STACK_PUSH("ZPP_InteractionGroupList::new","zpp_nape/util/Lists.hx",16014);
{
	HX_STACK_LINE(16069)
...
{
		HX_STACK_PUSH("ZPP_InteractionGroupList::invalidate","zpp_nape/util/Lists.hx",16061);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16062)
		this->_invalidated = true;
		HX_STACK_LINE(16063)
...
{
		HX_STACK_PUSH("ZPP_InteractionGroupList::validate","zpp_nape/util/Lists.hx",16055);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16055)
...
{
		HX_STACK_PUSH("ZPP_InteractionGroupList::modify_test","zpp_nape/util/Lists.hx",16050);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16050)
...
{
		HX_STACK_PUSH("ZPP_InteractionGroupList::modified","zpp_nape/util/Lists.hx",16045);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16046)
...
{
		HX_STACK_PUSH("ZPP_InteractionGroupList::valmod","zpp_nape/util/Lists.hx",16035);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16036)
		this->validate();
		HX_STACK_LINE(16037)
...
bool imm = __o_imm.Default(false);
	HX_STACK_PUSH("ZPP_InteractionGroupList::get","zpp_nape/util/Lists.hx",16028);
