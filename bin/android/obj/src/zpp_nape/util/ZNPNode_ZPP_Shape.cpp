...
{
HX_STACK_PUSH("ZNPNode_ZPP_Shape::new","zpp_nape/util/Lists.hx",13698);
{
	HX_STACK_LINE(13732)
	this->elt = null();
	HX_STACK_LINE(13723)
...
::zpp_nape::shape::ZPP_Shape ZNPNode_ZPP_Shape_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Shape::elem","zpp_nape/util/Lists.hx",13736);
	HX_STACK_THIS(this);
	HX_STACK_LINE(13736)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Shape::free","zpp_nape/util/Lists.hx",13729);
		HX_STACK_THIS(this);
		HX_STACK_LINE(13729)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Shape::alloc","zpp_nape/util/Lists.hx",13726);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_Shape"), hx::TCanCast< ZNPNode_ZPP_Shape_obj> ,sStaticFields,sMemberFields,
