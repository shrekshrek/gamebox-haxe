...
{
HX_STACK_PUSH("ZNPNode_ZPP_Edge::new","zpp_nape/util/Lists.hx",14518);
{
	HX_STACK_LINE(14552)
	this->elt = null();
	HX_STACK_LINE(14543)
...
::zpp_nape::shape::ZPP_Edge ZNPNode_ZPP_Edge_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Edge::elem","zpp_nape/util/Lists.hx",14556);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14556)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Edge::free","zpp_nape/util/Lists.hx",14549);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14549)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Edge::alloc","zpp_nape/util/Lists.hx",14546);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_Edge"), hx::TCanCast< ZNPNode_ZPP_Edge_obj> ,sStaticFields,sMemberFields,
