...
{
HX_STACK_PUSH("ZNPNode_ZPP_Listener::new","zpp_nape/util/Lists.hx",14723);
{
	HX_STACK_LINE(14757)
	this->elt = null();
	HX_STACK_LINE(14748)
...
::zpp_nape::callbacks::ZPP_Listener ZNPNode_ZPP_Listener_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Listener::elem","zpp_nape/util/Lists.hx",14761);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14761)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Listener::free","zpp_nape/util/Lists.hx",14754);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14754)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Listener::alloc","zpp_nape/util/Lists.hx",14751);
		HX_STACK_THIS(this);
	}
return null();
}
