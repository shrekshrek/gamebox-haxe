...
{
HX_STACK_PUSH("ZNPNode_ZPP_Body::new","zpp_nape/util/Lists.hx",13739);
{
	HX_STACK_LINE(13773)
	this->elt = null();
	HX_STACK_LINE(13764)
...
::zpp_nape::phys::ZPP_Body ZNPNode_ZPP_Body_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Body::elem","zpp_nape/util/Lists.hx",13777);
	HX_STACK_THIS(this);
	HX_STACK_LINE(13777)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Body::free","zpp_nape/util/Lists.hx",13770);
		HX_STACK_THIS(this);
		HX_STACK_LINE(13770)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Body::alloc","zpp_nape/util/Lists.hx",13767);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_Body"), hx::TCanCast< ZNPNode_ZPP_Body_obj> ,sStaticFields,sMemberFields,
