...
{
HX_STACK_PUSH("ZNPNode_ZPP_CbType::new","zpp_nape/util/Lists.hx",13616);
{
	HX_STACK_LINE(13650)
	this->elt = null();
	HX_STACK_LINE(13641)
...
::zpp_nape::callbacks::ZPP_CbType ZNPNode_ZPP_CbType_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_CbType::elem","zpp_nape/util/Lists.hx",13654);
	HX_STACK_THIS(this);
	HX_STACK_LINE(13654)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_CbType::free","zpp_nape/util/Lists.hx",13647);
		HX_STACK_THIS(this);
		HX_STACK_LINE(13647)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_CbType::alloc","zpp_nape/util/Lists.hx",13644);
		HX_STACK_THIS(this);
	}
return null();
}
