...
{
HX_STACK_PUSH("ZNPNode_ZPP_InteractionGroup::new","zpp_nape/util/Lists.hx",14887);
{
	HX_STACK_LINE(14921)
	this->elt = null();
	HX_STACK_LINE(14912)
...
::zpp_nape::dynamics::ZPP_InteractionGroup ZNPNode_ZPP_InteractionGroup_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_InteractionGroup::elem","zpp_nape/util/Lists.hx",14925);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14925)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_InteractionGroup::free","zpp_nape/util/Lists.hx",14918);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14918)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_InteractionGroup::alloc","zpp_nape/util/Lists.hx",14915);
		HX_STACK_THIS(this);
	}
return null();
}
