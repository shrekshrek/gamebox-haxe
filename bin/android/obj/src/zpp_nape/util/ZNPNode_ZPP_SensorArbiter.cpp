...
{
HX_STACK_PUSH("ZNPNode_ZPP_SensorArbiter::new","zpp_nape/util/Lists.hx",14682);
{
	HX_STACK_LINE(14716)
	this->elt = null();
	HX_STACK_LINE(14707)
...
::zpp_nape::dynamics::ZPP_SensorArbiter ZNPNode_ZPP_SensorArbiter_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_SensorArbiter::elem","zpp_nape/util/Lists.hx",14720);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14720)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_SensorArbiter::free","zpp_nape/util/Lists.hx",14713);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14713)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_SensorArbiter::alloc","zpp_nape/util/Lists.hx",14710);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_SensorArbiter"), hx::TCanCast< ZNPNode_ZPP_SensorArbiter_obj> ,sStaticFields,sMemberFields,
