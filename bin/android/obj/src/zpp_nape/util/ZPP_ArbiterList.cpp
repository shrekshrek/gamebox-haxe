...
{
HX_STACK_PUSH("ZPP_ArbiterList::new","zpp_nape/util/Lists.hx",16076);
{
	HX_STACK_LINE(16131)
...
{
		HX_STACK_PUSH("ZPP_ArbiterList::invalidate","zpp_nape/util/Lists.hx",16123);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16124)
		this->_invalidated = true;
		HX_STACK_LINE(16125)
...
{
		HX_STACK_PUSH("ZPP_ArbiterList::validate","zpp_nape/util/Lists.hx",16117);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16117)
...
{
		HX_STACK_PUSH("ZPP_ArbiterList::modify_test","zpp_nape/util/Lists.hx",16112);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16112)
...
{
		HX_STACK_PUSH("ZPP_ArbiterList::modified","zpp_nape/util/Lists.hx",16107);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16108)
...
{
		HX_STACK_PUSH("ZPP_ArbiterList::valmod","zpp_nape/util/Lists.hx",16097);
		HX_STACK_THIS(this);
		HX_STACK_LINE(16098)
		this->validate();
		HX_STACK_LINE(16099)
...
bool imm = __o_imm.Default(false);
	HX_STACK_PUSH("ZPP_ArbiterList::get","zpp_nape/util/Lists.hx",16090);
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZPP_ArbiterList"), hx::TCanCast< ZPP_ArbiterList_obj> ,sStaticFields,sMemberFields,
