...
{
HX_STACK_PUSH("ZNPNode_ZPP_PartitionedPoly::new","zpp_nape/util/Lists.hx",14272);
{
	HX_STACK_LINE(14306)
	this->elt = null();
	HX_STACK_LINE(14297)
...
::zpp_nape::geom::ZPP_PartitionedPoly ZNPNode_ZPP_PartitionedPoly_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_PartitionedPoly::elem","zpp_nape/util/Lists.hx",14310);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14310)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_PartitionedPoly::free","zpp_nape/util/Lists.hx",14303);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14303)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_PartitionedPoly::alloc","zpp_nape/util/Lists.hx",14300);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_PartitionedPoly"), hx::TCanCast< ZNPNode_ZPP_PartitionedPoly_obj> ,sStaticFields,sMemberFields,
