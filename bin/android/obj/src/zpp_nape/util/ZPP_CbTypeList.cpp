...
{
HX_STACK_PUSH("ZPP_CbTypeList::new","zpp_nape/util/Lists.hx",15580);
{
	HX_STACK_LINE(15635)
...
{
		HX_STACK_PUSH("ZPP_CbTypeList::invalidate","zpp_nape/util/Lists.hx",15627);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15628)
		this->_invalidated = true;
		HX_STACK_LINE(15629)
...
{
		HX_STACK_PUSH("ZPP_CbTypeList::validate","zpp_nape/util/Lists.hx",15621);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15621)
...
{
		HX_STACK_PUSH("ZPP_CbTypeList::modify_test","zpp_nape/util/Lists.hx",15616);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15616)
...
{
		HX_STACK_PUSH("ZPP_CbTypeList::modified","zpp_nape/util/Lists.hx",15611);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15612)
...
{
		HX_STACK_PUSH("ZPP_CbTypeList::valmod","zpp_nape/util/Lists.hx",15601);
		HX_STACK_THIS(this);
		HX_STACK_LINE(15602)
		this->validate();
		HX_STACK_LINE(15603)
...
bool imm = __o_imm.Default(false);
	HX_STACK_PUSH("ZPP_CbTypeList::get","zpp_nape/util/Lists.hx",15594);
