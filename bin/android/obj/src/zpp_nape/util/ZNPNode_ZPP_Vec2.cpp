...
{
HX_STACK_PUSH("ZNPNode_ZPP_Vec2::new","zpp_nape/util/Lists.hx",14600);
{
	HX_STACK_LINE(14634)
	this->elt = null();
	HX_STACK_LINE(14625)
...
::zpp_nape::geom::ZPP_Vec2 ZNPNode_ZPP_Vec2_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_Vec2::elem","zpp_nape/util/Lists.hx",14638);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14638)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Vec2::free","zpp_nape/util/Lists.hx",14631);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14631)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_Vec2::alloc","zpp_nape/util/Lists.hx",14628);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("zpp_nape.util.ZNPNode_ZPP_Vec2"), hx::TCanCast< ZNPNode_ZPP_Vec2_obj> ,sStaticFields,sMemberFields,
