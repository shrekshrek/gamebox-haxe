...
{
HX_STACK_PUSH("ZNPNode_ZPP_CbSetPair::new","zpp_nape/util/Lists.hx",14108);
{
	HX_STACK_LINE(14142)
	this->elt = null();
	HX_STACK_LINE(14133)
...
::zpp_nape::callbacks::ZPP_CbSetPair ZNPNode_ZPP_CbSetPair_obj::elem( ){
	HX_STACK_PUSH("ZNPNode_ZPP_CbSetPair::elem","zpp_nape/util/Lists.hx",14146);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14146)
	return this->elt;
}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_CbSetPair::free","zpp_nape/util/Lists.hx",14139);
		HX_STACK_THIS(this);
		HX_STACK_LINE(14139)
		this->elt = null();
	}
...
{
		HX_STACK_PUSH("ZNPNode_ZPP_CbSetPair::alloc","zpp_nape/util/Lists.hx",14136);
		HX_STACK_THIS(this);
	}
return null();
}
