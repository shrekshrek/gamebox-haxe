...
{
		HX_STACK_PUSH("ZPP_CbSet::alloc","zpp_nape/callbacks/CbSet.hx",508);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
		HX_STACK_PUSH("ZPP_CbSet::free","zpp_nape/callbacks/CbSet.hx",459);
		HX_STACK_THIS(this);
		HX_STACK_LINE(460)
		{
		}
...
{
		HX_STACK_PUSH("ZPP_CbSet::remInteractor","zpp_nape/callbacks/CbSet.hx",428);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ZPP_CbSet::remConstraint","zpp_nape/callbacks/CbSet.hx",426);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("ZPP_CbSet::addInteractor","zpp_nape/callbacks/CbSet.hx",424);
		HX_STACK_THIS(this);
		HX_STACK_ARG(intx,"intx");
		HX_STACK_LINE(424)
...
bool ZPP_CbSet_obj::setlt( ::zpp_nape::callbacks::ZPP_CbSet a,::zpp_nape::callbacks::ZPP_CbSet b){
	HX_STACK_PUSH("ZPP_CbSet::setlt","zpp_nape/callbacks/CbSet.hx",428);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_LINE(429)
...
::zpp_nape::callbacks::ZPP_CbSet ZPP_CbSet_obj::get( ::zpp_nape::util::ZNPList_ZPP_CbType cbTypes){
	HX_STACK_PUSH("ZPP_CbSet::get","zpp_nape/callbacks/CbSet.hx",533);
...
bool ZPP_CbSet_obj::compatible( ::zpp_nape::callbacks::ZPP_InteractionListener i,::zpp_nape::callbacks::ZPP_CbSet a,::zpp_nape::callbacks::ZPP_CbSet b){
	HX_STACK_PUSH("ZPP_CbSet::compatible","zpp_nape/callbacks/CbSet.hx",569);
	HX_STACK_ARG(i,"i");
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	struct _Function_1_1{
		inline static bool Block( ::zpp_nape::callbacks::ZPP_InteractionListener &i,::zpp_nape::callbacks::ZPP_CbSet &a){
			HX_STACK_PUSH("*::closure","zpp_nape/callbacks/CbSet.hx",570);
			{
				HX_STACK_LINE(570)
...
bool ZPP_CbSet_obj::empty_intersection( ::zpp_nape::callbacks::ZPP_CbSet a,::zpp_nape::callbacks::ZPP_CbSet b){
	HX_STACK_PUSH("ZPP_CbSet::empty_intersection","zpp_nape/callbacks/CbSet.hx",573);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	struct _Function_1_1{
		inline static bool Block( ::zpp_nape::callbacks::ZPP_CbSet &a,::zpp_nape::callbacks::ZPP_CbSet &b){
			HX_STACK_PUSH("*::closure","zpp_nape/callbacks/CbSet.hx",574);
			{
				HX_STACK_LINE(574)
				{
				}
...
bool ZPP_CbSet_obj::single_intersection( ::zpp_nape::callbacks::ZPP_CbSet a,::zpp_nape::callbacks::ZPP_CbSet b,::zpp_nape::callbacks::ZPP_InteractionListener i){
	HX_STACK_PUSH("ZPP_CbSet::single_intersection","zpp_nape/callbacks/CbSet.hx",576);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(i,"i");
	struct _Function_1_1{
		inline static bool Block( ::zpp_nape::callbacks::ZPP_CbSet &b,::zpp_nape::callbacks::ZPP_CbSet &a,::zpp_nape::callbacks::ZPP_InteractionListener &i){
			HX_STACK_PUSH("*::closure","zpp_nape/callbacks/CbSet.hx",577);
			{
				HX_STACK_LINE(577)
				{
				}
...
{
		HX_STACK_PUSH("ZPP_CbSet::find_all","zpp_nape/callbacks/CbSet.hx",580);
		HX_STACK_ARG(a,"a");
		HX_STACK_ARG(b,"b");
		...
		HX_STACK_LINE(581)
		{
			struct _Function_2_1{
				inline static ::zpp_nape::callbacks::ZPP_CbSetPair Block( ::zpp_nape::callbacks::ZPP_CbSet &a,::zpp_nape::callbacks::ZPP_CbSet &b){
					HX_STACK_PUSH("*::closure","zpp_nape/callbacks/CbSet.hx",581);
					{
						HX_STACK_LINE(581)
						::zpp_nape::callbacks::ZPP_CbSetPair ret = null();		HX_STACK_VAR(ret,"ret");
						HX_STACK_LINE(581)
