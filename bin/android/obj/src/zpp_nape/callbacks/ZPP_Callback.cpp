...
{
		HX_STACK_PUSH("ZPP_Callback::genarbs","zpp_nape/callbacks/Callback.hx",410);
		HX_STACK_THIS(this);
		HX_STACK_LINE(411)
		{
		}
...
{
		HX_STACK_PUSH("ZPP_Callback::alloc","zpp_nape/callbacks/Callback.hx",401);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
		HX_STACK_PUSH("ZPP_Callback::free","zpp_nape/callbacks/Callback.hx",389);
		HX_STACK_THIS(this);
		HX_STACK_LINE(390)
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::rev_at( int i){
	HX_STACK_PUSH("ZPP_Callback::rev_at","zpp_nape/callbacks/Callback.hx",350);
	HX_STACK_THIS(this);
	HX_STACK_ARG(i,"i");
	HX_STACK_LINE(351)
	{
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::at( int i){
	HX_STACK_PUSH("ZPP_Callback::at","zpp_nape/callbacks/Callback.hx",337);
	HX_STACK_THIS(this);
	HX_STACK_ARG(i,"i");
	HX_STACK_LINE(338)
	{
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::cyclePrev( ::zpp_nape::callbacks::ZPP_Callback o){
	HX_STACK_PUSH("ZPP_Callback::cyclePrev","zpp_nape/callbacks/Callback.hx",325);
	HX_STACK_THIS(this);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(326)
	{
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::cycleNext( ::zpp_nape::callbacks::ZPP_Callback o){
	HX_STACK_PUSH("ZPP_Callback::cycleNext","zpp_nape/callbacks/Callback.hx",313);
	HX_STACK_THIS(this);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(314)
	{
...
{
		HX_STACK_PUSH("ZPP_Callback::rotateR","zpp_nape/callbacks/Callback.hx",310);
		HX_STACK_THIS(this);
		HX_STACK_LINE(310)
...
{
		HX_STACK_PUSH("ZPP_Callback::rotateL","zpp_nape/callbacks/Callback.hx",307);
		HX_STACK_THIS(this);
		HX_STACK_LINE(307)
		this->push(this->pop());
	}
...
::zpp_nape::callbacks::ZPP_Callback ZPP_Callback_obj::splice( ::zpp_nape::callbacks::ZPP_Callback o){
	HX_STACK_PUSH("ZPP_Callback::splice","zpp_nape/callbacks/Callback.hx",292);
	HX_STACK_THIS(this);
	HX_STACK_ARG(o,"o");
	HX_STACK_LINE(293)
...
{
		HX_STACK_PUSH("ZPP_Callback::clear","zpp_nape/callbacks/Callback.hx",292);
		HX_STACK_THIS(this);
		HX_STACK_LINE(292)
		while((!(this->empty()))){
			HX_STACK_LINE(292)
