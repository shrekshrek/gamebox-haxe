...
{
		HX_STACK_PUSH("ZPP_LineJoint::draw","zpp_nape/constraint/LineJoint.hx",1544);
		HX_STACK_THIS(this);
		HX_STACK_ARG(g,"g");
		HX_STACK_LINE(1545)
		...
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::nape::constraint::LineJoint &me){
				HX_STACK_PUSH("*::closure","zpp_nape/constraint/LineJoint.hx",1546);
				{
					HX_STACK_LINE(1546)
		...
		if (((pn > min))){
			struct _Function_2_1{
				inline static Float Block( Float &pn,Float &max){
					HX_STACK_PUSH("*::closure","zpp_nape/constraint/LineJoint.hx",1559);
					{
						HX_STACK_LINE(1560)
		...
		if (((pn < max))){
			struct _Function_2_1{
				inline static Float Block( Float &pn,Float &min){
					HX_STACK_PUSH("*::closure","zpp_nape/constraint/LineJoint.hx",1564);
					{
						HX_STACK_LINE(1565)
						Float x = pn;		HX_STACK_VAR(x,"x");
						HX_STACK_LINE(1566)
		...
		if ((!(this->stiff))){
			struct _Function_2_1{
				inline static ::nape::geom::Vec2 Block( ::nape::geom::Vec2 &e1){
					HX_STACK_PUSH("*::closure","zpp_nape/constraint/LineJoint.hx",1570);
					{
						HX_STACK_LINE(1570)
...
bool ZPP_LineJoint_obj::applyImpulsePos( ){
	HX_STACK_PUSH("ZPP_LineJoint::applyImpulsePos","zpp_nape/constraint/LineJoint.hx",1278);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1279)
...
bool ZPP_LineJoint_obj::applyImpulseVel( ){
	HX_STACK_PUSH("ZPP_LineJoint::applyImpulseVel","zpp_nape/constraint/LineJoint.hx",1075);
	HX_STACK_THIS(this);
	HX_STACK_LINE(1076)
	Float Ex = 0.0;		HX_STACK_VAR(Ex,"Ex");
	HX_STACK_LINE(1077)
						...
						HX_STACK_LINE(1175)
						{
							struct _Function_7_1{
								inline static Float Block( Float &ls){
									HX_STACK_PUSH("*::closure","zpp_nape/constraint/LineJoint.hx",1176);
									{
										HX_STACK_LINE(1176)
										{
										}
...
{
		HX_STACK_PUSH("ZPP_LineJoint::warmStart","zpp_nape/constraint/LineJoint.hx",993);
		HX_STACK_THIS(this);
		HX_STACK_LINE(995)
