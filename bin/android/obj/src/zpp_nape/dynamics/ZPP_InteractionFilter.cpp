...
{
		HX_STACK_PUSH("ZPP_InteractionFilter::invalidate","zpp_nape/dynamics/InteractionFilter.hx",298);
		HX_STACK_THIS(this);
		HX_STACK_LINE(300)
...
bool ZPP_InteractionFilter_obj::shouldFlow( ::zpp_nape::dynamics::ZPP_InteractionFilter x){
	HX_STACK_PUSH("ZPP_InteractionFilter::shouldFlow","zpp_nape/dynamics/InteractionFilter.hx",295);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_LINE(295)
...
bool ZPP_InteractionFilter_obj::shouldSense( ::zpp_nape::dynamics::ZPP_InteractionFilter x){
	HX_STACK_PUSH("ZPP_InteractionFilter::shouldSense","zpp_nape/dynamics/InteractionFilter.hx",288);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_LINE(288)
...
bool ZPP_InteractionFilter_obj::shouldCollide( ::zpp_nape::dynamics::ZPP_InteractionFilter x){
	HX_STACK_PUSH("ZPP_InteractionFilter::shouldCollide","zpp_nape/dynamics/InteractionFilter.hx",281);
	HX_STACK_THIS(this);
	HX_STACK_ARG(x,"x");
	HX_STACK_LINE(281)
...
::zpp_nape::dynamics::ZPP_InteractionFilter ZPP_InteractionFilter_obj::copy( ){
	HX_STACK_PUSH("ZPP_InteractionFilter::copy","zpp_nape/dynamics/InteractionFilter.hx",250);
	HX_STACK_THIS(this);
	HX_STACK_LINE(251)
...
{
		HX_STACK_PUSH("ZPP_InteractionFilter::remShape","zpp_nape/dynamics/InteractionFilter.hx",245);
		HX_STACK_THIS(this);
