...
{
HX_STACK_PUSH("ZPP_Component::new","zpp_nape/space/Space.hx",543);
{
	HX_STACK_LINE(577)
	this->woken = false;
	HX_STACK_LINE(576)
...
{
		HX_STACK_PUSH("ZPP_Component::reset","zpp_nape/space/Space.hx",601);
		HX_STACK_THIS(this);
		HX_STACK_LINE(602)
		this->sleeping = false;
		HX_STACK_LINE(603)
...
{
		HX_STACK_PUSH("ZPP_Component::alloc","zpp_nape/space/Space.hx",594);
		HX_STACK_THIS(this);
	}
return null();
}
...
{
		HX_STACK_PUSH("ZPP_Component::free","zpp_nape/space/Space.hx",580);
		HX_STACK_THIS(this);
		HX_STACK_LINE(581)
		this->body = null();
		HX_STACK_LINE(582)
