...
{
		HX_STACK_PUSH("ZPP_FluidProperties::invalidate","zpp_nape/phys/FluidProperties.hx",349);
		HX_STACK_THIS(this);
		HX_STACK_LINE(351)
...
{
		HX_STACK_PUSH("ZPP_FluidProperties::getgravity","zpp_nape/phys/FluidProperties.hx",343);
		HX_STACK_THIS(this);
		struct _Function_1_1{
			inline static ::nape::geom::Vec2 Block( ::zpp_nape::phys::ZPP_FluidProperties_obj *__this){
				HX_STACK_PUSH("*::closure","zpp_nape/phys/FluidProperties.hx",344);
				{
					HX_STACK_LINE(344)
...
{
		HX_STACK_PUSH("ZPP_FluidProperties::gravity_validate","zpp_nape/phys/FluidProperties.hx",321);
		HX_STACK_THIS(this);
		HX_STACK_LINE(323)
...
{
		HX_STACK_PUSH("ZPP_FluidProperties::gravity_invalidate","zpp_nape/phys/FluidProperties.hx",298);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(299)
		{
...
::zpp_nape::phys::ZPP_FluidProperties ZPP_FluidProperties_obj::copy( ){
	HX_STACK_PUSH("ZPP_FluidProperties::copy","zpp_nape/phys/FluidProperties.hx",245);
	HX_STACK_THIS(this);
	HX_STACK_LINE(246)
...
{
		HX_STACK_PUSH("ZPP_FluidProperties::remShape","zpp_nape/phys/FluidProperties.hx",245);
		HX_STACK_THIS(this);
