...
{
		HX_STACK_PUSH("ZPP_Material::invalidate","zpp_nape/phys/Material.hx",278);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(280)
...
{
		HX_STACK_PUSH("ZPP_Material::set","zpp_nape/phys/Material.hx",267);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_LINE(268)
...
::zpp_nape::phys::ZPP_Material ZPP_Material_obj::copy( ){
	HX_STACK_PUSH("ZPP_Material::copy","zpp_nape/phys/Material.hx",258);
	HX_STACK_THIS(this);
	HX_STACK_LINE(259)
...
{
		HX_STACK_PUSH("ZPP_Material::remShape","zpp_nape/phys/Material.hx",245);
		HX_STACK_THIS(this);
