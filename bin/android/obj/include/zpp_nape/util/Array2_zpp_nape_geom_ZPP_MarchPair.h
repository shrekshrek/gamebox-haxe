...
#define INCLUDED_zpp_nape_util_Array2_zpp_nape_geom_ZPP_MarchPair
...
class Array2_zpp_nape_geom_ZPP_MarchPair_obj : public hx::Object{
	public:
		typedef hx::Object super;
		typedef Array2_zpp_nape_geom_ZPP_MarchPair_obj OBJ_;
		Array2_zpp_nape_geom_ZPP_MarchPair_obj();
		Void __construct(int width,int height);

	public:
		static hx::ObjectPtr< Array2_zpp_nape_geom_ZPP_MarchPair_obj > __new(int width,int height);
		...
		::String __ToString() const { return HX_CSTRING("Array2_zpp_nape_geom_ZPP_MarchPair"); }
...
#endif /* INCLUDED_zpp_nape_util_Array2_zpp_nape_geom_ZPP_MarchPair */ 
