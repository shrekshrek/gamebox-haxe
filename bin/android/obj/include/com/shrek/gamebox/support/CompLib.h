...
class CompLib_obj : public hx::Object{
	...
	public:
		...
		static ::native::display::Sprite createTextBox( ::String inLabel,int inW,int inH,int inColor,hx::Null< int >  inSize);
		static Dynamic createTextBox_dyn();

		static ::native::text::TextField createTextField( int inColor,hx::Null< int >  inSize);
		static Dynamic createTextField_dyn();

		static ::native::display::Sprite getBmpToSprite( ::String inPath);
		static Dynamic getBmpToSprite_dyn();

		static ::native::display::Sprite getCircleHit( int inR);
		static Dynamic getCircleHit_dyn();
