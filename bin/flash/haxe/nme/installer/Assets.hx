...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("images/game1/bullet.png", NME_images_game1_bullet_png);
			resourceTypes.set ("images/game1/bullet.png", "image");
			resourceClasses.set ("images/game1/plane.png", NME_images_game1_plane_png);
			resourceTypes.set ("images/game1/plane.png", "image");
			resourceClasses.set ("images/nav/bg.jpg", NME_images_nav_bg_jpg);
			resourceTypes.set ("images/nav/bg.jpg", "image");
			resourceClasses.set ("xml/app.xml", NME_xml_app_xml);
